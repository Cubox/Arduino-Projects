...
unsigned long   sampletime_ms = 30 * 1000;  // Durée de mesure - sample time (ms)
...
void updateAQI() {
  ...
  Serial.print("PM10 ratio: "); Serial.print(ratio); Serial.print("\n");
  ...
  //Serial.print("PM25 ratio: "); Serial.print(ratio); Serial.print("\n");
...
void setup() {
  ...
  // wait 2s for DSM501 to warm up
  for (int i = 1; i <= 2; i++)
  {
    delay(1000); // 1s
    Serial.print(i);
    Serial.println(" s (wait 2s for DSM501 to warm up)");
  }

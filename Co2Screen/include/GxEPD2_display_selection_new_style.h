...
// Co2Screen: panel is tri-color (GDEY0213Z98 / GxEPD2_213_Z98c).
// You can still draw only black/white, but you MUST keep the tri-color driver for this panel.
...
// If you see "Busy Timeout!" in Serial, double-check BUSY wiring or try setting EPD_BUSY_PIN to -1.
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=*/EPD_CS_PIN, /*DC=*/EPD_DC_PIN, /*RST=*/EPD_RST_PIN, /*BUSY=*/EPD_BUSY_PIN));

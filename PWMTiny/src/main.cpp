...
/*
  tone() Melody Player With Melodies Converted From Pokemon_RedBlueYellow_-_Wild_Pokemon_Battle.mid
  ------------------------------------------------------------------------------  
...
void playMelody(uint8_t, unsigned int);
...
void playMelody_Data(const uint16_t MelodyData[], const uint16_t MelodyLength, const unsigned int tempo)
{
...
inline static void playMelody(uint8_t melodyNumber, unsigned int tempo)
{
  switch(melodyNumber)
  {
